...
const Navbar = ({ theme = "dark" }) => {
  ...
  useEffect(() => {
    const handleScrollAndDetectTheme = () => {
      ...
      const sections = document.querySelectorAll(
        "section, header, footer, [data-theme]",
      );
  ...
  return (
    <>
      <nav
        className={`fixed inset-x-0 z-50 flex justify-center transition-all duration-300 ${navPositionClass}`}
      >
        <div
          className={`flex w-full items-center justify-between transition-all duration-300 ${containerClass}`}
        >
          <Link
            to="/"
            className="flex items-center gap-[12px] relative z-[60] group"
          >
            <img
            ...
            />
            <span
              className={`${isLight ? "text-[#191919]" : "text-white"} font-semibold text-[24px] leading-none font-sans tracking-tight transition-colors duration-300`}
            >
              PrimeOrbit
            </span>
          </Link>
          ...
          <div
            className={`hidden lg:flex items-center gap-[46px] ${isLight ? "text-[#191919]" : "text-white"} transition-colors duration-300`}
          >
            <Link
              to="/"
              className={`${location.pathname === "/" ? activeNavClass : inactiveDesktopNavClass} transition-colors text-[16px] leading-[19.2px] font-inter`}
            >
              Home
            </Link>
            <Link
              to="/services"
              className={`${location.pathname === "/services" ? activeNavClass : inactiveDesktopNavClass} transition-colors text-[16px] leading-[19.2px] font-inter`}
            >
              Services
            </Link>
            <Link
              to="/tracking"
              className={`${location.pathname === "/tracking" ? activeNavClass : inactiveDesktopNavClass} transition-colors text-[16px] leading-[19.2px] font-inter`}
            >
              Tracking
            </Link>
            <Link
              to="/global-network"
              className={`${location.pathname === "/global-network" ? activeNavClass : inactiveDesktopNavClass} transition-colors text-[16px] leading-[19.2px] font-inter`}
            >
              Global Network
            </Link>
            <Link
              to="/why-choose-us"
              className={`${location.pathname === "/why-choose-us" ? activeNavClass : inactiveDesktopNavClass} transition-colors text-[16px] leading-[19.2px] font-inter`}
            >
              Why Choose Us
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col gap-[36px] items-center">
          <Link
            to="/"
            className={`text-[22px] font-medium transition-colors duration-300 ${location.pathname === "/" ? activeNavClass : inactiveMobileNavClass}`}
          >
            Home
          </Link>
          <Link
            to="/services"
            className={`text-[22px] font-medium transition-colors duration-300 ${location.pathname === "/services" ? activeNavClass : inactiveMobileNavClass}`}
          >
            Services
          </Link>
          <Link
            to="/tracking"
            className={`text-[22px] font-medium transition-colors duration-300 ${location.pathname === "/tracking" ? activeNavClass : inactiveMobileNavClass}`}
          >
            Tracking
          </Link>
          <Link
            to="/global-network"
            className={`text-[22px] font-medium transition-colors duration-300 ${location.pathname === "/global-network" ? activeNavClass : inactiveMobileNavClass}`}
          >
            Global Network
          </Link>
          <Link
            to="/why-choose-us"
            className={`text-[22px] font-medium transition-colors duration-300 ${location.pathname === "/why-choose-us" ? activeNavClass : inactiveMobileNavClass}`}
          >
            Why Choose Us
          </Link>
        </div>

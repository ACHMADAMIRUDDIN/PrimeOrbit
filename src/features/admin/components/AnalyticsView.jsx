...
const AnalyticsView = () => {
  ...
  const recentShipments = [
    {
      ...
      shipDate: "2024-03-15",
      estDate: "2024-03-15",
      route: "San Francisco, CA → New York, NY",
      price: "$45.00",
      status: "Delivered",
    },
    {
    ...
    },
    {
      ...
      shipDate: "2024-03-18",
      estDate: "2024-03-18",
      route: "Detroit, MI → Los Angeles, CA",
      price: "$50.00",
      status: "Processing",
    },
    {
      ...
      shipDate: "2024-03-12",
      estDate: "2024-03-12",
      route: "New York, NY → Madrid, SP",
      price: "$77.00",
      status: "In Transit",
    },
    {
      id: "22394SPG",
      company: "AlcatrazTech",
      shipDate: "2024-03-07",
      estDate: "2024-03-07",
      route: "Chicago, IL → Birmingham, EN",
      price: "$95.00",
      status: "Processing",
    },
  ];
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "Delivered":
        return "bg-[#d9f9e7] text-[#02bc57]";
      case "Out for Delivery":
        return "bg-[#fcdfe0] text-[#f04a4a]";
      case "In Transit":
        return "bg-[#fef7d6] text-[#d6b712]";
      case "Processing":
        return "bg-[#dde1f9] text-[#4663fe]";
      default:
    ...
    <div className="flex flex-col gap-[24px] font-work text-black w-full min-w-0 max-w-full">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[20px] w-full">
        {kpiData.map((kpi, idx) => (
          <div
            key={idx}
            className="w-full rounded-[24px] bg-white p-[20px] flex flex-col gap-[8px] shadow-sm"
          >
            <div className="flex items-center justify-between">
              <span className="font-medium tracking-[-0.01em] text-[18px]">
                {kpi.title}
              </span>
              <div
                className={`w-[35px] h-[35px] rounded-[10px] ${kpi.iconBg} flex items-center justify-center`}
              >
                {kpi.icon}
              </div>
            </div>
            <div className="flex flex-col gap-[8px] mt-[4px]">
              <span className="text-[32px] leading-[120%] font-medium text-[#1e2939]">
                {kpi.count}
              </span>
              <div className="flex items-center justify-between text-[14px]">
                <div
                  className={`flex items-center gap-[8px] rounded-full ${kpi.isPositive ? "bg-[#eff6ff] text-[#00bc7d]" : "bg-[#ffdfe3] text-[#fb2c36]"} px-[12px] py-[6px]`}
                >
                  <img
                    src={image[kpi.arrowImage]}
                    alt="arrow"
                    className="w-[12px] h-[8px] object-contain"
                  />
      ...
      <div className="flex flex-col xl:flex-row gap-[20px] w-full font-jakarta">
        <div className="flex-1 rounded-[24px] bg-white border border-[#efeff1] shadow-[0_4px_18px_rgba(230,229,234,0.27)] p-[24px_28px] flex flex-col gap-[20px] min-h-[560px] relative overflow-hidden">
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-[4px]">
              <h3 className="font-work font-medium text-[18px] tracking-[-0.01em]">
                Logistics Performance
              </h3>
              <p className="text-[13px] text-[#797979] tracking-[-0.02em]">
                You can see monthly logistic volume from here
              </p>
            </div>
          ...
          <div className="flex-1 flex items-center justify-center w-full mt-4 min-h-[420px]">
            ...
            >
              ...
              <g
                ...
                textAnchor="end"
              >
                <text x="65" y="30" dominantBaseline="middle">
                  $100K
                </text>
                <text x="65" y="100" dominantBaseline="middle">
                  $75K
                </text>
                <text x="65" y="170" dominantBaseline="middle">
                  $50K
                </text>
                <text x="65" y="240" dominantBaseline="middle">
                  $25K
                </text>
                <text x="65" y="310" dominantBaseline="middle">
                  $0K
                </text>
              </g>
        ...
        <div className="w-full xl:w-[380px] rounded-[24px] bg-white border border-[#efeff1] shadow-[0_4px_18px_rgba(230,229,234,0.27)] p-[24px] flex flex-col shrink-0 min-h-[560px] font-work text-[10px]">
          <div className="flex items-center justify-between mb-[20px]">
            <h3 className="font-work font-medium text-[20px] md:text-[22px] tracking-[-0.01em] text-[#191919]">
              Routes in Transit
            </h3>
          ...
          <div className="flex flex-col gap-[20px]">
            <div className="w-full rounded-[24px] bg-[#20236a] p-[24px] flex flex-col gap-[20px] text-white relative shadow-md">
              ...
              <div className="flex flex-col gap-[4px]">
                <span className="font-semibold text-[20px] tracking-tight leading-tight">
                  Wardrobe Package
                </span>
                <span className="text-[12px] opacity-80">
                  Invoice Number:{" "}
                  <span className="font-medium">3823KRU8429</span>
                </span>
              </div>
              ...
              <div className="relative w-full h-[32px] flex items-center justify-between mt-2 z-10">
                ...
                <div className="w-[32px] h-[32px] rounded-full bg-white flex items-center justify-center text-[#20236a] shrink-0 z-10 shadow-sm">
                  <Plane
                    size={14}
                    className="fill-[#20236a] text-[#20236a] rotate-45"
                  />
                </div>
            ...
            <div className="w-full rounded-[24px] bg-white border border-gray-100 p-[24px] flex flex-col gap-[20px] text-[#191919] relative shadow-sm">
              ...
              <div className="flex flex-col gap-[4px]">
                ...
                <span className="text-[12px] text-gray-500">
                  Invoice Number:{" "}
                  <span className="font-medium text-gray-700">3823KRU8429</span>
                </span>
              </div>
              ...
              <div className="relative w-full h-[32px] flex items-center justify-between mt-2 z-10">
                ...
                <div className="w-[32px] h-[32px] rounded-full bg-[#20236a] flex items-center justify-center text-white shrink-0 z-10 shadow-sm border-[2.2px] border-white">
                  <Plane
                    size={14}
                    className="fill-white text-white rotate-45"
                  />
                </div>
          ...
          <div className="flex items-center gap-[12px] text-[12px] text-[#8a8a8a]">
            <div className="flex items-center gap-[6px] bg-[#f0f0f0] rounded-[8px] px-[8px] py-[6px] w-[193px]">
              ...
              <input
                type="text"
                placeholder="Search.."
                className="bg-transparent border-none outline-none flex-1 text-[#333]"
              />
            </div>
            ...
            <div className="flex items-center gap-[4px] ml-2 font-semibold text-[#333]">
              ...
              <div className="flex items-center">
                <button className="p-[4px] hover:bg-gray-100 rounded-lg">
                  <ChevronLeft size={16} />
                </button>
                <button className="p-[4px] hover:bg-gray-100 rounded-lg">
          ...
          <div className="min-w-[850px] w-full flex flex-col gap-[2px] text-[12px]">
            ...
            <div className="w-full flex flex-col">
              {recentShipments.map((shipment, idx) => (
                <div
                  key={idx}
                  className="w-full flex items-center px-[8px] py-[4px] border-b border-[#f0f0f0] hover:bg-gray-50 transition-colors font-semibold"
                >
                  <div className="w-[100px] p-[10px_4px]">{shipment.id}</div>
                  <div className="w-[120px] p-[10px_4px]">
                    {shipment.company}
                  </div>
                  <div className="w-[110px] p-[10px_4px]">
                    {shipment.shipDate}
                  </div>
                  <div className="w-[110px] p-[10px_4px]">
                    {shipment.estDate}
                  </div>
                  <div className="flex-1 p-[10px_4px] truncate">
                    {shipment.route}
                  </div>
                  <div className="w-[80px] p-[10px_4px]">{shipment.price}</div>
                  <div className="w-[120px] p-[10px_4px]">
                    <span
                      className={`px-[8px] py-[2px] rounded-full text-[10px] ${getStatusColor(shipment.status)}`}
                    >
                      {shipment.status}
                    </span>
                  </div>

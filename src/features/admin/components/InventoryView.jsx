        ...
        <div className="space-y-6">
          <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100 flex flex-col transition-all hover:shadow-md">
            ...
            <div className="flex items-center gap-[16px] mb-6">
              <span className="text-[42px] font-bold text-[#20236a] leading-none">
                88%
              </span>
              <span className="text-[#989dab] text-[13px] font-medium leading-none mt-1">
          ...
          <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100 transition-all hover:shadow-md">
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="text-[#989dab] text-xs font-semibold">
                13:48
              </span>
            </div>
            <p className="text-[#989dab] text-[13px] leading-relaxed font-normal mt-3">
              Lorem ipsum dolor sit amet consectetur. Eros sagittis duis massa
              amet mauris vel at aliquet. Venenatis pellentesque sit.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-sm">
                Avg. daily demand: 18 units - Stock left: 14 units
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-5">
              ...
              <p className="font-semibold text-secondary mb-1">
                Stock level approaching critical minimum.
              </p>
              <p className="text-gray-500 text-sm">
                Minimum level: 20 units - Available: 7 units
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="border border-gray-200 rounded-2xl p-5 flex gap-4 items-start"
              >
                ...
                <div>
                  <h4 className="font-bold text-secondary mb-1">
                    {i === 1 ? "Supply Chain" : "Warehouse Efficiency"}
                  </h4>
                  <p className="text-gray-500 text-sm">
                    Inbound shipment accuracy increased by 14% this week after
                    vendor schedule
                  </p>
                </div>
              </div>

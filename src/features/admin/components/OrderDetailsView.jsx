      ...
      <div className="flex flex-col xl:flex-row gap-[20px] w-full">
        <div className="flex-1 rounded-[24px] bg-white border border-[#efeff1] shadow-[0_4px_18px_rgba(230,229,234,0.27)] p-[24px] flex flex-col gap-[20px] min-h-[450px]">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-[16px]">
            <div className="flex flex-col gap-[8px]">
              <h3 className="font-work font-medium text-[18px] tracking-[-0.01em] text-[#191919] leading-[120%]">
                Shipping Location
              </h3>
        ...
        <div className="w-full xl:w-[420px] rounded-[24px] bg-white border border-[#efeff1] shadow-[0_4px_18px_rgba(230,229,234,0.27)] p-[24px] flex flex-col gap-[20px] shrink-0 min-h-[450px]">
          <div className="flex items-center justify-between gap-[20px]">
            <h3 className="font-work font-medium text-[18px] tracking-[-0.01em] text-[#191919]">
              Shipping Revenue
            </h3>
          ...
          <div className="relative flex items-center justify-center font-work mt-2 h-[130px]">
            <div className="absolute inset-x-0 bottom-[8px] flex flex-col items-center justify-center text-center pointer-events-none">
              <span className="text-[12px] text-[#797979] font-medium tracking-[-0.01em]">
                Total Revenue
              </span>
              <span className="text-[26px] leading-[120%] text-[#20236a] font-bold mt-0.5 mb-0.5">
                $473,265
              </span>
              <span className="text-[12px] text-[#797979] font-medium tracking-[-0.01em]">
          ...
          <div className="w-full">
            ...
            >
              ...
              <g
                ...
                textAnchor="end"
              >
                <text x="25" y="29" dominantBaseline="middle">
                  Q1
                </text>
                <text x="25" y="69" dominantBaseline="middle">
                  Q2
                </text>
                <text x="25" y="109" dominantBaseline="middle">
                  Q3
                </text>
                <text x="25" y="149" dominantBaseline="middle">
                  Q4
                </text>
              </g>
        ...
        <div className="w-full overflow-x-auto">
          <div className="min-w-[850px] w-full flex flex-col gap-[2px] text-[12px]">
            <div className="w-full bg-[#f5f5f5] rounded-t-[6px] flex items-center px-[8px] py-[4px] text-[#333] font-semibold">
              <div className="w-[100px] p-[10px_4px] flex items-center gap-[4px]">
                Order ID <ChevronDown size={12} />
              </div>
              <div className="w-[120px] p-[10px_4px] flex items-center gap-[4px]">
                Company <ChevronDown size={12} />
              </div>
              <div className="w-[110px] p-[10px_4px] flex items-center gap-[4px]">
                Shipping Date <ChevronDown size={12} />
              </div>
              <div className="w-[110px] p-[10px_4px] flex items-center gap-[4px]">
                Estimate Date <ChevronDown size={12} />
              </div>
              <div className="flex-1 p-[10px_4px] flex items-center gap-[4px]">
                Route <ChevronDown size={12} />
              </div>
              <div className="w-[80px] p-[10px_4px] flex items-center gap-[4px]">

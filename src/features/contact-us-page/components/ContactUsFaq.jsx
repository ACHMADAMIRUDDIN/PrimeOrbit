...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "We accommodate shipments of all sizes. For very small parcels, we offer consolidated shipping options, while full containers are available for large volume cargo.",
  },
  {
    question: "How do I book a shipment?",
    answer:
      "You can book directly through our platform by creating an account, selecting your route and cargo type, or by contacting our sales team for custom solutions.",
  },
  {
    question: "How far in advance should I book?",
    answer:
      "We recommend booking at least 7-14 days in advance for sea freight and 3-5 days for air freight to ensure capacity and optimal pricing.",
  },
];
...
const ContactUsFaq = () => {
  ...
  return (
    <section
      data-theme="light"
      className="w-full bg-white flex flex-col p-[40px] lg:p-[100px_80px_105px] gap-[40px] font-sans text-black max-w-[1440px] mx-auto"
    >
        ...
        <div className="w-full lg:w-[535px] rounded-[30px] bg-[#ebebf5] flex flex-col p-[30px] md:p-[40px] gap-[24px] shrink-0">
          <div className="flex flex-col gap-[24px]">
            ...
            <p className="text-[16px] md:text-[18px] leading-[140%] text-[#4e5b72] font-medium">
              ...
              <a
                href="mailto:support@Primeorbit.com"
                className="text-[#2a2a7c] hover:underline"
              >

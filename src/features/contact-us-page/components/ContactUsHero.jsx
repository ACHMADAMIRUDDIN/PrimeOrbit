...
const ContactUsHero = () => {
  return (
    <section
      data-theme="dark"
      className="w-full relative min-h-[833px] overflow-hidden flex flex-col justify-center px-[20px] lg:px-[86px] pt-[150px] pb-[80px] font-sans text-white"
    >
        ...
        <div className="w-full lg:w-[512px] flex flex-col gap-[60px] lg:gap-[150px]">
          ...
          <div className="flex flex-col gap-[10px] md:gap-[6.5px] font-figtree">
            <div className="flex items-center gap-[12px]">
              ...
              <span className="text-[24px] md:text-[32.46px] leading-[128%]">
                +01 235 235-02-53
              </span>
            </div>
            <div className="flex items-center gap-[12px] font-sans">
              <Mail className="opacity-70 hidden md:block" />
              <span className="text-[24px] md:text-[32px] leading-[120%] font-medium text-white">
                Primebit@gmail.com
              </span>
            </div>
          </div>

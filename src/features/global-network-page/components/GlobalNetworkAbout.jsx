...
const DATA_ITEMS = [
  {
    ...
    shortDesc: "Recognized as one of the world's largest integrated logistics providers by container volume and global presence.",
    detailTitle: 'Integrated Logistics, Global Network',
    detailDesc: "Expanding horizons by connecting major trade lanes seamlessly, ensuring high capacity and dependable ocean freight operations worldwide.",
  ...
  },
  {
    ...
    shortDesc: 'Among the first to implement AI-driven route optimization and blockchain-enabled cargo tracking.',
    detailTitle: 'Smart Logistics, Smarter Future',
    detailDesc: "At PrimeOrbit, technology isn't an add-on it's the core of how we move faster, safer, and smarter. From AI to blockchain, we continuously evolve to lead the future of global logistics.",
  ...
  },
  {
    ...
    shortDesc: 'Efficiently moving millions of containers across seas and borders, fueling international trade.',
    detailTitle: 'Massive Scale Container Operations',
    detailDesc: "Streamlining large-scale port operations with ultra-precise scheduling and high-throughput terminal logistics management.",
  ...
  },
  {
    ...
    shortDesc: 'Awarded for green shipping initiatives and fleet upgrades aimed at reducing carbon emissions.',
    detailTitle: 'Eco-Friendly Modern Fleet',
    detailDesc: "Committing to sustainable supply chains by deploying energy-efficient maritime transport vessels and smart carbon auditing metrics.",
    imgAsset: image.warehouseOperations,
    features: [
...
const GlobalNetworkAbout = () => {
  ...
  return (
    <section data-theme="light" className="w-full bg-white flex flex-col items-center py-24 px-6 md:px-12 font-inter antialiased text-black">
            ...
            >
              ...
              >
                ...
                <div className="flex-1 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-10 relative">
                  ...
                  {/* Deskripsi Pendek */}
                  <p className={`w-full md:max-w-[536px] text-[14px] md:text-[16px] leading-[1.5] font-normal transition-all duration-500 pr-[10px] md:pr-[40px] ${
                    isOpen 
                  ...
                  {/* 🛠️ TOMBOL PANAH INTERAKTIF DENGAN BACKGROUND BIRU SAAT ON */}
                  <div className={`hidden lg:flex items-center justify-center shrink-0 transition-all duration-500 ${
                    isOpen 
              ...
              >
                <div className="w-full h-[420px] md:h-[520px] rounded-[32px] relative overflow-hidden bg-gray-100 shadow-sm">
                  <img 
                    src={item.imgAsset || "https://images.unsplash.com/photo-1578574437130-527eed3abbec?auto=format&fit=crop&q=80&w=1200"} 
                    alt={item.title} 
                        ...
                        return (
                          <div key={idx} className="flex items-center gap-3">
                            <span className="flex h-[18px] w-[18px] items-center justify-center rounded-[5px] bg-[#3B82F6]/15 shrink-0">
                              <IconComponent size={11} className="text-[#2a2a7c] stroke-[2.5]" />
                            </span>

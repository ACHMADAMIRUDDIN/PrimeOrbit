      ...
      <div className="w-full lg:w-[540px] h-[240px] md:h-[300px] rounded-[24px] bg-gray-800 relative overflow-hidden flex flex-col justify-end p-[20px] md:p-[24px_24px] gap-[12px]">
        ...
        <div className="w-full md:w-[480px] h-[46px] rounded-[10px] bg-white text-[#1e1e1e] flex items-center justify-between p-[8px_16px_8px_12px] z-10 font-poppins">
          <div className="flex items-center gap-[10px]">
            ...
            <span className="leading-[130%] font-light text-[13px] md:text-[14px]">Fast & Reliable Delivery</span>
          </div>
      ...
      <div className="w-full lg:w-[500px] flex flex-col items-start gap-[30px] md:gap-[50px]">
        ...
        <div className="flex items-center gap-[36px] md:gap-[24px] font-poppins">
          ...
          <div className="flex flex-col gap-[8px]">
            <span className="text-[28px] md:text-[36px] font-normal leading-[130%] text-white">120+</span>
            <span className="text-[13px] md:text-[15px] leading-[120%] font-sans opacity-80">Countries Covered</span>
          </div>

          <div className="flex flex-col gap-[8px]">
            <span className="text-[28px] md:text-[36px] font-normal leading-[130%] text-white">24/7</span>

    ...
    <section data-theme="dark" className="w-full bg-[#1b1b1b] flex flex-col lg:flex-row items-center justify-between p-[40px] md:p-[60px_80px_60px_100px] gap-[40px] lg:gap-[30px] text-white font-sans">
      ...
      <div className="w-full lg:w-[500px] flex flex-col items-start gap-[30px] md:gap-[50px]">
        ...
        <div className="flex items-center gap-[36px] md:gap-[24px] font-poppins mt-[16px] md:mt-[24px]">
          ...
          {/* Nilai translate-y dinaikkan dari [4px] ke [10px] agar lebih mendesak ke bawah */}
          <div className="flex flex-col gap-[8px] transform translate-y-[10px]">
            <span className="text-[22px] md:text-[28px] font-normal leading-[130%] text-white">120+</span>
            <span className="text-[13px] md:text-[15px] leading-[120%] font-sans opacity-80">Countries Covered</span>
          </div>

          {/* Nilai translate-y dinaikkan dari [4px] ke [10px] agar lebih mendesak ke bawah */}
          <div className="flex flex-col gap-[8px] transform translate-y-[10px]">
            <span className="text-[22px] md:text-[28px] font-normal leading-[130%] text-white">24/7</span>

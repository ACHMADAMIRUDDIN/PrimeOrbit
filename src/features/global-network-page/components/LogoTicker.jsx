...
// Data logo tiruan sesuai dengan gambar yang dikirim
const logos = [
  {
    name: 'Cubekit',
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-white/60" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 100-16 8 8 0 000 16z" stroke="currentColor" strokeWidth="2" fill="none" className="animate-pulse"/>
  ...
  },
  {
    name: 'Euphoria',
    icon: (
      <svg className="w-6 h-6 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
...
const LogoTicker = () => {
  // Kita duplikasi array-nya agar perulangan animasinya tidak terputus di layar lebar
  const duplicatedLogos = [...logos, ...logos, ...logos];

  return (
    <div data-theme="dark" className="w-full bg-[#191919] py-8 overflow-hidden border-t border-white/5 relative">
      {/* Efek gradient shadow di kiri dan kanan agar terlihat memudar (fade out) */}

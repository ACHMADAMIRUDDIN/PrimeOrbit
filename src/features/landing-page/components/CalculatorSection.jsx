...
const LocationSelectRow = ({ value, onClick, isOpen }) => (
  ...
  >
    <TargetMarkerIcon />
    <span className="flex-1 text-[14px] font-medium text-[#1c1c1c]">
      {value}
    </span>
    <ChevronDown
...
const LocationSelector = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative rounded-[22px] bg-white px-[18px] py-[12px] shadow-[0px_8px_18px_rgba(15,23,42,0.05)]"
    >
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-[#F8F9FA] rounded-3xl p-6 md:p-8 border border-gray-100 shadow-inner">
              <div className="mb-8 flex items-center gap-3">
                ...
                <h3 className="text-[15px] font-medium text-[#5a5a5a]">
                  Shipment Details
                </h3>
              </div>
              ...
              <form className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    ...
                    <input
                      type="text"
                      defaultValue="125 kg"
                      className="w-full bg-white border border-gray-200 rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
                    />
                  </div>
                  <div className="flex-1">
                    <label className="block text-xs text-gray-500 mb-2 font-medium">
                ...
                <button
                  type="button"
                  className="w-full bg-secondary text-white py-4 rounded-xl hover:bg-secondary/90 transition-colors font-medium mt-4"
                >
                  Calculate
                </button>
              </form>

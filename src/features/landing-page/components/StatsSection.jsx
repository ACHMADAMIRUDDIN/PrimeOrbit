...
const StatsSection = () => {
  return (
    <section
      id="about"
      data-theme="dark"
      className="w-full bg-[#191919] text-white pt-[50px] pb-[100px] flex justify-center items-center overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full mb-8 lg:mb-12">
          <div className="lg:col-span-7 flex items-center">
            <div className="text-white">
              <svg
                className="w-[58px] h-[66px] text-white"
                viewBox="0 0 76 86"
                fill="currentColor"
              >
          ...
          <div className="lg:col-span-5 flex flex-col gap-16 lg:gap-20">
            ...
            <div className="flex flex-col gap-6 max-w-[540px]">
              ...
              <p className="text-sm md:text-base text-gray-400 leading-relaxed font-inter font-bold">
                We provide end-to-end logistics solutions designed for the
                modern era. From intelligent warehousing to real-time fleet
                management, we streamline your operations for scalability.
              </p>
            </div>
          </div>

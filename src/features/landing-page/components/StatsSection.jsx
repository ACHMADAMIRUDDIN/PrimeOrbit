...
const StatsSection = () => {
  return (
    <section id="about" data-theme="dark" className="w-full bg-[#191919] text-white pt-[50px] pb-[100px] flex justify-center items-center overflow-hidden">
  <div className="w-full max-w-[1320px] px-4 md:px-[60px] flex flex-col relative">

    {/* Header Row: Logo & Subtitle */}
    {/* Diubah: mb-16 lg:mb-24 diperpendek menjadi mb-8 lg:mb-12 */}
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full mb-8 lg:mb-12">
      <div className="lg:col-span-7 flex items-center">
        {/* Logo */}
        {/* Diubah: Menghapus pt-20 agar logo sejajar sempurna secara vertikal dengan teks kanan */}
      ...
      {/* Diubah: Menghapus mt-4 lg:mt-20 agar teks tidak dipaksa turun dan sejajar dengan logo */}

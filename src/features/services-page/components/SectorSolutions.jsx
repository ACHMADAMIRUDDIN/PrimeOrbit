...
const SectorSolutions = () => {
  return (
    <section className="bg-[#f5f5f5] w-full py-[80px] px-4 md:px-[120px] flex flex-col gap-[80px] text-black overflow-hidden">
      ...
      {/* Grid Content */}
      <div className="w-full flex flex-col lg:flex-row items-stretch gap-[19px] font-poppins">
        
        {/* Image 1 */}
        <div className="flex-1 min-h-[480px] rounded-[24px] overflow-hidden">
          <img src={image.airCargoPlane} alt="Air Cargo" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="w-full lg:w-[386.8px] flex flex-col gap-[20px] flex-shrink-0">
          ...
          {/* Card 98% */}
          <div className="h-[230px] rounded-[24px] bg-primary p-[20px_30px_20px_19px] flex flex-col justify-between">
            <h3 className="text-[50px] leading-[130%] font-medium text-[#1e1e1e]">98%</h3>
          ...
          {/* Card 15+ */}
          <div className="h-[230px] rounded-[24px] bg-white p-[20px_30px_20px_19px] flex flex-col justify-between">
            ...
            <h3 className="text-[50px] leading-[130%] font-medium text-[#1e1e1e] mt-auto">15+</h3>
            <p className="text-[16px] leading-[130%] font-light text-[#1e1e1e] max-w-[337px] mt-2">
        ...
        {/* Image 2 */}
        <div className="flex-1 min-h-[480px] rounded-[24px] overflow-hidden">
          <img src={image.containerYard} alt="Logistics" className="w-full h-full object-cover" />
        </div>

...
const TrackingFaq = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "We handle general goods, bulk cargo, high-value items, fragile shipments, and more—via air, sea, and road.",
    },
    {
      question: "Is there a minimum shipment size?",
      answer:
        "No, we handle shipments of all sizes, from small parcels to full container loads.",
    },
    {
      question: "How do I book a shipment?",
      answer:
        "You can book directly through our online platform or contact our sales team for assistance.",
    },
    {
      question: "How far in advance should I book?",
      answer:
        "We recommend booking at least 3-5 days in advance to ensure availability and best rates.",
    },
  ];
  ...
  return (
    <section
      data-theme="light"
      className="w-full bg-white flex flex-col p-[40px] md:p-[100px_80px_105px] gap-[37px] text-[#2d2d2d] font-sans"
    >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-[40px] lg:gap-[64px] mt-8">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-[24px]">
                  <span className="font-sans font-semibold text-[18px] md:text-[22px] text-[#1c1c1c] tracking-tight leading-[130%]">
                    {faq.question}
                  </span>
                  {isOpen ? (
                    <Minus size={24} className="text-[#1c1c1c] shrink-0" />
                  ) : (
                    <Plus size={24} className="text-[#1c1c1c] shrink-0" />
                  )}
                </div>
                {isOpen && (
        ...
        <div className="lg:col-span-5 w-full bg-[#ebebf5] rounded-[32px] p-[32px_32px_48px_32px] md:p-[40px_40px_48px_40px] flex flex-col gap-[28px]">
          <div className="flex flex-col gap-[16px]">
            <h3 className="text-[28px] md:text-[34px] font-sans font-semibold text-[#1c1c1c] tracking-tight leading-[120%]">
              Still need help?
            </h3>
            <p className="text-[16px] md:text-[18px] leading-[150%] text-[#4e5b72] font-sans font-normal">
              Click on the blue round button at the bottom right corner of this
              page. You can also email our support team at{" "}
              <span className="text-[#21287c] font-bold">

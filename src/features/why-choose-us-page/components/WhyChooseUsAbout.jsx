...
const WhyChooseUsAbout = () => {
  return (
    <section
      data-theme="dark"
      className="w-full bg-black text-white flex flex-col items-center p-[60px_20px] md:p-[80px_120px] gap-[40px] md:gap-[46px] text-center overflow-hidden"
    >
      ...
      <div className="w-full max-w-[1200px] text-[24px] md:text-[32px] leading-[140%] font-medium font-figtree">
        ...
        <span className="text-[#f5f5f5]/60">
          , we don't just move cargo — we move{" "}
        </span>
        ...
        <span>trust</span>
        <span className="text-[#f5f5f5]/60">
          . Backed by decades of experience and a powerful global network, we
          connect{" "}
        </span>
